...
class Alunos(models.Model):
    ...
    login_cadastro = models.CharField(max_length=15)
...
class Alunosxturmas(models.Model):
    id_turma = models.ForeignKey('Turmas', models.DO_NOTHING, db_column='id_turma')
    id_aluno = models.ForeignKey(Alunos, models.DO_NOTHING, db_column='id_aluno')
    valor = models.DecimalField(max_digits=13, decimal_places=2)
    valor_desconto = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True)
    data_cadastro = models.DateTimeField()
    login_cadastro = models.CharField(max_length=15)
...
class Situacao(models.Model):
    id_situacao = models.IntegerField(primary_key=True)
    situacao = models.CharField(max_length=25)
    data_cadastro = models.DateTimeField(blank=True, null=True)
    login_cadastro = models.CharField(max_length=15, blank=True, null=True)
